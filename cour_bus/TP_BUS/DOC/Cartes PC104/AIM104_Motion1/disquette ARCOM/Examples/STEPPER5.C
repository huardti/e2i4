...
/* Module Name:    STEPPER5.C                                               */
/*                 Copyright (c) 1998 Arcom Control Systems Ltd.            */
/*                                                                          */
/* ======================================================================== */
/*                                                                          */
/* Summary:        STEPPER5.C - AIM104-MOTION-1 example program for stepper */
/*                              motor in Position Control mode, using full  */
/*										  steps.													 */
/*                                                                          */
/* Language:       ANSI C                                                   */
...
unsigned char mode;
	...
	clrscr();
	printf("STEPPER5 PROGRAM RUNNING... \n");
	...
	MOTION_set_board_config_reg(axis_0,0x02);		// full-step, 2 phase-on
	...
	// INITIALIZE CONTROLLER
		...
		MOTION_program_commutator(axis_0,0,40,10,0,0,0);	 // Ring=40, X=10, Y=0
